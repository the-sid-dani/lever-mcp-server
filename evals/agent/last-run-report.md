...
- Timestamp: 2026-05-29T22:25:01.736Z
...
| GT-011 | PASS | lever_requisitions | ToolSearch, lever_requisitions, Bash, ToolSearch, Read, Grep | expected tool called: lever_requisitions; substantive answer with expected tool |
...
| GT-008 | PASS | lever_search_candidates -> lever_get_candidate | ToolSearch, lever_search_candidates, lever_list_applications, lever_list_applications, lever_get_candidate, lever_get_candidate | all sequence tools called: lever_search_candidates -> lever_get_candidate; non-empty data answer with expected tool |
| GT-009 | FAIL | lever_feedback | ToolSearch, lever_feedback | expected tool called: lever_feedback; final text reports not-found / crash |
| GT-010 | PASS | lever_archive | ToolSearch, lever_archive, lever_archive, lever_archive, ToolSearch | expected tool called: lever_archive; substantive answer with expected tool |
